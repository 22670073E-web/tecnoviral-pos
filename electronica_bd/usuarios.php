...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['accion'])) {
    ...
    if ($_POST['accion'] == 'cambiar_rol') {
        $id      = intval($_POST['id']);
        $nuevo   = $_POST['nuevo_rol'] == 'administrador' ? 'administrador' : 'vendedor';
                    ...
                    <div class="rol-selector">
                        <div class="rol-option">
                            ...
                            <label for="rol_vendedor" class="vendedor-lbl">
                                ...
                                <span>Vendedor</span>
                                <small>Acceso a ventas, productos e inventario</small>
                            </label>
                        </div>
                        <div class="rol-option">
                            ...
                            <label for="rol_admin" class="admin-lbl">
                                ...
                                <small>Acceso total incluyendo usuarios y reportes</small>
                            </label>
                        </div>
                    </div>
                </div>
                        ...
                        <td data-label="Acciones">
                            <div class="action-btns">
                                ...
                                <form method="POST" style="display:inline;">
                                    ...
                                    <input type="hidden" name="nuevo_rol" value="<?php echo $u['rol'] == 'administrador' ? 'vendedor' : 'administrador'; ?>">
                                    <button type="submit" class="btn-act btn-rol"
                                        title="<?php echo $u['rol'] == 'administrador' ? 'Cambiar a Vendedor' : 'Cambiar a Admin'; ?>"
