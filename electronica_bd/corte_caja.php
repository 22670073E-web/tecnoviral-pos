...
<div class="page-wrap">
    ...
    <?php endif; // fin bloque caja abierta (stats + tablas) ?>
    ...
    <?php elseif ($user_rol == 'administrador'): ?>
    ...
    <div class="glass-card anim anim-3" style="margin-top:28px;text-align:center;padding:32px;">
        ...
        <div style="font-family:'Playfair Display',serif;font-size:1.1rem;font-weight:700;margin-bottom:8px;">Solo administradores pueden realizar el corte</div>
        <div style="font-size:.85rem;color:rgba(255,255,255,.4);">Puedes ver el estado del turno, pero el cierre requiere permisos de administrador.</div>
    </div>
