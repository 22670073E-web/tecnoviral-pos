...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['accion'])) {
    ...
    if ($_POST['accion'] == 'eliminar' && $user_rol == 'administrador') {
        $id = intval($_POST['id']);
...
$cond_usuario = $user_rol != 'administrador' ? " AND id_usuario = $user_id" : '';
    ...
    <div class="glass-card anim anim-3" style="padding:24px 28px;">
        <div class="table-wrap">
            <table class="tv-table">
                ...
                <?php endwhile; else: ?>
                <tr>
                    <td colspan="<?php echo $user_rol == 'administrador' ? '7' : '5'; ?>">
