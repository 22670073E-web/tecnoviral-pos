...
if ($user_rol == 'administrador' && isset($_GET['eliminar'])) {
        ...
        <form method="GET" action="">
            <div class="filtros-wrap">
                ...
                <div>
                    ...
                    <div class="date-tabs">
                        <button type="submit" name="fecha" value="hoy"    class="date-tab <?php echo $filtro_fecha=='hoy'    ? 'active' : ''; ?>"><i class="fas fa-sun me-1"></i>Hoy</button>
                        <button type="submit" name="fecha" value="semana" class="date-tab <?php echo $filtro_fecha=='semana' ? 'active' : ''; ?>"><i class="fas fa-calendar-week me-1"></i>7 días</button>
                        <button type="submit" name="fecha" value="mes"    class="date-tab <?php echo $filtro_fecha=='mes'    ? 'active' : ''; ?>"><i class="fas fa-calendar me-1"></i>Este mes</button>
                        <button type="submit" name="fecha" value="rango"  class="date-tab <?php echo $filtro_fecha=='rango'  ? 'active' : ''; ?>"><i class="fas fa-calendar-range me-1"></i>Rango</button>
                    </div>
                </div>
                <!-- fecha se envía via button submit o hidden para no-rango -->
                ...
                <!-- Vendedor (solo admin) -->
                <?php if ($user_rol == 'administrador' && $result_vendedores): ?>
                <div>
