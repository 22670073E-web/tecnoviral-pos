...
<div class="page-wrap">
    ...
    <!-- ══ ACCESOS RÁPIDOS ══ -->
    <div class="section-head">
        <div class="s-label">Accesos rápidos</div>
        <div class="s-line"></div>
    </div>

    <div class="quick-row">
        <a href="punto_venta.php?nueva_venta=1" class="quick-btn">
            <i class="fas fa-plus-circle"></i> Nueva Venta
        </a>
        <a href="productos.php?accion=nuevo" class="quick-btn">
            <i class="fas fa-plus-circle"></i> Nuevo Producto
        </a>
        <a href="gastos.php?nuevo=1" class="quick-btn">
            <i class="fas fa-plus-circle"></i> Registrar Gasto
        </a>
        <?php if (!$caja_abierta): ?>
        <a href="corte_caja.php?abrir=1" class="quick-btn">
            <i class="fas fa-play-circle"></i> Abrir Caja
        </a>
        <?php else: ?>
        <a href="corte_caja.php?cerrar=1" class="quick-btn">
